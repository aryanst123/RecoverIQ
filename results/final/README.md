...
4. `oracle_diagnostic.json`: Simulator-only counterfactual oracle benchmarking policy regret against optimal potential outcomes.
...
9. `reproducibility.json`: Deterministic replay verification confirming byte-for-byte reproducibility on unmutated cohort slices.
