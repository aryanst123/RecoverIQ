...
export const Safety: React.FC = () => {
  ...
  const liveScenarios = [
    ...
    {
      id: 'F4_OUT_OF_BAND_CAPTURE',
      name: 'F4 — Out-of-Band Payment Capture',
      desc: 'Payment captured out-of-band on gateway halts outreach immediately; execution blocked, residual ₹0.00.',
      invariant: 'INV-1 & INV-7',
    },
    {
      id: 'F5_CONCURRENT_RACE',
      name: 'F5 — Concurrent Execution Race',
      desc: 'Two simultaneous execution requests arrive for the same case; lock & reservation service allows 1, blocks duplicate.',
      invariant: 'INV-5 & INV-8',
    },
    {
      id: 'F6_OPT_OUT',
